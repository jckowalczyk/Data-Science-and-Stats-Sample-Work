---
title: "Analysis of Couchto5k Programe Data"
...
source("https://uoepsy.github.io/data/usmr_2122_data.R") #remember to change this
```
...
The researchers' interests are two-fold:
...
Having built a baseline model, we can now examine whether variables associated with the Couchto5k program influence participant happiness scores. One question that can be asked is whether participants' happiness ratings affected by whether or not they completed the programme?
